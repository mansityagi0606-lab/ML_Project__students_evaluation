...
def test_dynamic_optional_dependencies(tmp_path):
    files = {
        "requirements.txt-docs.txt": "sphinx\n  # comment\n",
        "pyproject.toml": cleandoc(
            """
            [project]
            name = "myproj"
            ...
            file = ["requirements.txt-docs.txt"]
...
def test_mixed_dynamic_optional_dependencies(tmp_path):
    ...
    """
    files = {
        "requirements.txt-images.txt": "pillow~=42.0\n  # comment\n",
        "pyproject.toml": cleandoc(
            """
            [project]
            name = "myproj"
            ...
            file = ["requirements.txt-images.txt"]
